...
<g id="LIGHTS">
	...
	<g id="AIRSCRUBBERS">
		<g id="AIRSCRUBBERS-PARAMS-class:coldSmoke_23_">
			<circle fill="#005F61" cx="1739" cy="2341.39" r="128"/>
		</g>
		<g id="AIRSCRUBBERS-PARAMS-class:dimAmber">
	...
	<g id="EXTERIOR">
		<g id="EXTERIOR-FileTab-PARAMS-class:extArcUp_1_">
			<circle fill="#0000FF" cx="2960.58" cy="358.58" r="459.42"/>
		</g>
		<g id="EXTERIOR-ShipLabel-PARAMS-class:extArcUp_1_">
			<circle fill="#0000FF" cx="772.95" cy="687" r="1120"/>
		</g>
		<g id="EXTERIOR-PARAMS-class:exterior_11_">
			<ellipse fill="#0000FF" cx="801.5" cy="3783" rx="908.5" ry="881"/>
		</g>
		<g id="EXTERIOR-PARAMS-class:exterior_4_">
			<circle fill="#0000FF" cx="2562.58" cy="1135.58" r="289.58"/>
		</g>
		<g id="EXTERIOR-PARAMS-class:exterior_3_">
			<ellipse fill="#0000FF" cx="2679.5" cy="3775" rx="908.5" ry="881"/>
		</g>
		<g id="EXTERIOR-LateralView-PARAMS-class:extArcUp_1_">
...
export default async (svgXML, isClearingExistingLights = false, isClearingExistingWalls = true) => {
  ...
  if (typeof svgXML === "string" && /<((poly)?line|circle)/.test(svgXML)) {
    ...
    const getRadius = (radius) => parseInt(radius) / canvas.scene.data.grid;
