...
export default (() => ({
  ...
  "~createChatMessage": (message) => {
    ...
    console.log(message);
    if (/Critical Injuries on Xenos table/i.test(message.data.flavor)) {
      message.update({blind: true});
    } else if (game?.user?.isGM && /Critical injuries table|Critical Injuries on Synthetics/i.test(message.data.flavor)) {
